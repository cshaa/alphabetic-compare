import { Block, BlockMatch, Cluster, Comparison, Config, Letter, LetterMatch, PatternMatch, Sorting, SortingMatch } from "./types";
...
export declare function matchBlock(str: string, block: Block, whole: boolean): BlockMatch | null;
